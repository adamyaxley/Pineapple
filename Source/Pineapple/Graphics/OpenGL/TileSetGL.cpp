...
std::unique_ptr<pa::Map> pa::TileSetGL::createMap(float x, float y, const pa::TileMap tilemap, bool hWrap, bool vWrap,
												  int priority)
{
	PA_ASSERTF(isLoaded(), "Tileset is not loaded");
	return std::make_unique<pa::MapGL>(m_graphics, *this, x, y, tilemap, hWrap, vWrap, priority);
}
